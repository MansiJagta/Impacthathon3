                    ...
                    <tbody>
                        {recent_claims.length > 0 ? (
                            recent_claims.map((c, i) => (
                                ...
                                >
                                    <td style={{ padding: "20px 24px", color: C.accent, fontWeight: 700, fontSize: 13 }}>
                                        {c.claim_id}
                                    </td>
                                    ...
                                    <td style={{ padding: "20px 24px", color: C.text, fontWeight: 800 }}>
                                        ₹{c.claim_amount?.toLocaleString()}
                                    </td>

                                    <td style={{ padding: "20px 24px", color: C.muted, fontSize: 12 }}>
                                        {c.summary}
                                    </td>

            ...
            <div style={{
                ...
                <div style={{ marginTop: 40, borderTop: `1px solid ${C.border}`, paddingTop: 30 }}>
                    ...
                    <div style={{ display: "flex", gap: 16 }}>
                        <ActionButton label="Approve Claim" color="#22c55e" onClick={() => handleAction("Approve")} disabled={isSubmitting} />
                        <ActionButton label="Reject / Fraud" color="#ef4444" onClick={() => handleAction("Reject")} disabled={isSubmitting} />
                    </div>
                </div>
            </div>
        </div>
